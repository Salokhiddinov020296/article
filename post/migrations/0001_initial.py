# Generated by Django 4.1 on 2022-12-22 12:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article_pdf', models.FileField(blank=True, max_length=255, null=True, upload_to='article/', verbose_name='Maqola (pdf)')),
                ...
                ('writer_document', models.ImageField(blank=True, max_length=255, null=True, upload_to='images/document/', verbose_name='Mualliflik Guvohnomasi')),
                ('greeting_card', models.ImageField(blank=True, max_length=255, null=True, upload_to='images/greeting_card/', verbose_name='Diplom')),
                ('greeting_card2', models.ImageField(blank=True, max_length=255, null=True, upload_to='images/greeting_card/', verbose_name='Diplom2')),
                ('greeting_card3', models.ImageField(blank=True, max_length=255, null=True, upload_to='images/greeting_card/', verbose_name='Diplom3')),
                ('greeting_card4', models.ImageField(blank=True, max_length=255, null=True, upload_to='images/greeting_card/', verbose_name='Diplom4')),
                ('handbook', models.ImageField(blank=True, max_length=255, null=True, upload_to='images/handbook/', verbose_name="Ma'lumotnoma")),
                ('certificate', models.ImageField(blank=True, max_length=255, null=True, upload_to='images/certificate/', verbose_name='Sertifikat')),
                ('author1', models.CharField(max_length=60, verbose_name='Muallif(1)')),
                ('author2', models.CharField(blank=True, max_length=60, null=True, verbose_name='Muallif(2)')),
                ('author3', models.CharField(blank=True, max_length=60, null=True, verbose_name='Muallif(3)')),
                ('author4', models.CharField(blank=True, max_length=60, null=True, verbose_name='Muallif(4)')),
