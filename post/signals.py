...
def writeToCertificate(fullname, fullname2, link, qrlink, theme, date):
    try:
        ...
        img = Image.open('/var//html//documents//certificate.jpg')
    ...
    try:
        ...
        myFont = ImageFont.truetype('/var//html//TNR//timesnewromanbold.ttf', 214)
        fullnameFont = ImageFont.truetype('/var//html//TNR//timesnewromanbold.ttf', 268)
        linkFont = ImageFont.truetype('/var//html//TNR//timesnewromanbolditalic.ttf', 200)
    ...
    if len(theme) > 45:
        try:
            ...
            myFont = ImageFont.truetype('/var//html//TNR//timesnewromanbold.ttf', 208)
...
def writetoDiplom(fullname, qrlink, tdate, theme):
    try:
        ...
        img = Image.open('/var//html//documents//diplom.jpg')
        draw = ImageDraw.Draw(img)
        fullnameFont = ImageFont.truetype('/var//html//TNR//timesnewromanbold.ttf', 80)
        numFont = ImageFont.truetype('/var//html//TNR//timesnewromanbold.ttf', 60)
        myFont = ImageFont.truetype('/var//html//TNR//timesnewromanbold.ttf', 28)
        theFont = ImageFont.truetype('/var//html//TNR//timesnewromanbold.ttf', 64)
    image_width = img.width
    image_height = img.height
    margin = 0
...
def writetoGuvohnoma(qrlink, num, tdate, fullname, theme, fullname2):
    try:
        img = Image.open('/var//html//documents//guvohnoma.jpg')
        draw = ImageDraw.Draw(img)
        myFont = ImageFont.truetype('/var//html//TNR//timesnewromanbold.ttf', 100)
        fullnameFont = ImageFont.truetype('/var//html//TNR//timesnewromanbold.ttf', 96)
        numFont = ImageFont.truetype('/var//html//TNR//timesnewromanbold.ttf', 92)
    except:
...
def writeMalumotnoma(fullname, doilink, openairelink, openaccesslink, cyberleninkalink, google, zenodolink, theme,
                     fullname2, today):
    try:
        img = Image.open('/var//html//documents//malumotnoma.jpeg')
        linkFont = ImageFont.truetype('/var//html//TNR//timesnewromanitalic.ttf', 70)
        themeFont = ImageFont.truetype('/var//html//TNR//timesnewromanitalic.ttf', 55)
    except:
